...
# Result table
>>>>>>> 123d800e2f5003df52d614656bd68711f9f1e200
...
The most useful predictors when trying to classify kangaroos are `nasal.length`, `mandable.width`, `crest.width`, and `nasal.width`. These predictors are much more importnat than any of the other ones, as `nasal.length`, `mandable.width`, and `crest.width` all have importance greater than 90. The least important predictors are `lacrymal.width`, `palate.length`, and `basilar.length`. They all have importance less than 3.1, showing how vastly unimportant they are compared to the most important predictors. From this information, we know that the less important predictors could probably be removed from our model if we wanted to build a simpler model. The plot below shows the absolute value of the coefficients of all of the predictors in our model.
<<<<<<< HEAD
=======
